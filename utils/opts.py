...
def train_opts(parser):
    ...
    group.add('--train_from', default='', type=str,
              help="Path to the pretrained model's checkpoint.")

    # Optimization
    group = parser.add_argument_group('Optimization')
    group.add('--batch_size', type=int, default=64,
    ...
    group.add('--valid_steps', type=int, default=10000,
              help='Perfom validation every X steps')
    group.add('--beam_width', type=int, default=8,
              help="Width of beam for decoding during validation.")
    group.add('--nbest', type=int, default=1,
              help="Number of hypotheses to find.")
    ...
    group.add('--print_every', type=int, default=50,
    ...
    group.add("--log_dir", type=str, default="runs",
...
def translate_opts(parser):
    ...
    group.add('--split', choices=['train', 'valid', 'test'], default='test',
              help='Split to be used for evaluation')
    group.add('--checkpoint', type=str, required=True,
    ...
    group.add('--excluded_toks', type=str, default='',
              help='Comma-separated list of tokens to be excluded '
                    'during decoding')

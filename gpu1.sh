...
# python preprocess.py -data_type audio -src_dir /home/data/MCV-v3/clips -train_src data/common-voice/us-v3/src-train.txt -train_tgt data/common-voice/us-v3/tgt-train.txt.converted -valid_src data/common-voice/us-v3/src-val.txt -valid_tgt data/common-voice/us-v3/tgt-val.txt.converted -shard_size 3000 -save_data data/common-voice/shards/us-v3/sentencepiece-level --tgt_seq_length 1000 --src_seq_length 1000 -sample_rate 48000 --overwrite -shard_size 6000
...
CUDA_VISIBLE_DEVICES=1 python train.py -model_type audio \
  	...
  	-save_model saved/v3_sp_drop_5_pool_2_bi_enc_512_dec_2/model \
  	...
  	-keep_checkpoint 3 \
  	-tensorboard \
  	-tensorboard_log_dir runs/v3_sp_drop_5_pool_2_bi_enc_512_dec_2 \
  	-gpu_ranks 0 \
 	-sample_rate 48000

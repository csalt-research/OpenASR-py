...
# python preprocess.py -data_type audio -src_dir /home/data/MCV-v3/clips -train_src data/common-voice/us-v3/src-train.txt.filtered -train_tgt data/common-voice/us-v3/tgt-train.txt.filtered.converted -valid_src data/common-voice/us-v3/src-val.txt.filtered -valid_tgt data/common-voice/us-v3/tgt-val.txt.filtered.converted -save_data data/common-voice/shards/us-v3/sentencepiece-level --overwrite --tgt_seq_length 1000 --src_seq_length 1000 -sample_rate 48000 -shard_size 6000
